...
def main(_argv):
    ...
    for crop in crops:
        if crop.shape[0] > 0 and crop.shape[1] > 0:
            ...
            # if FLAGS.framework == 'tflite':
            interpreter2 = tf.lite.Interpreter(model_path="./checkpoints/yolov4-tiny-step3-416-fp16.tflite")
            ...
            sort_indices = np.argsort(x_coords_max.flatten())
            ...
            cv2.imwrite(FLAGS.output, image2)
